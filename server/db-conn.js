...
async function insertRealData() {
  ...
  const PredictiveAnalyticsInHealthcare = await Service.create({
    ...
    banner: 'https://images.techhive.com/images/article/2015/07/health-analytics-ts-100599204-large.jpg',
    evocativePhoto: '',
    serviceTitle: '',
    serviceDescription: '',
    partnerTitle: '',
  ...
  const PredictionScenarioAnalysis = await Service.create({
    ...
    banner: 'https://image.shutterstock.com/image-photo/predictive-analytics-big-data-analysis-260nw-1348992500.jpg',
    evocativePhoto: '',
    serviceTitle: '',
    serviceDescription: '',
    partnerTitle: '',
  ...
  const BIDWHConsulting = await Service.create({
    ...
    banner: 'https://www.smartdatacollective.com/wp-content/uploads/2020/11/business-intelligence-future-in-coming-years.jpg',
    evocativePhoto: '',
    serviceTitle: '',
    serviceDescription: '',
    partnerTitle: '',
  ...
  const PricingOptimization = await Service.create({
    ...
    banner: 'https://associationsnow.com/wp-content/uploads/2018/12/GettyImages-940692576_hrvcc-600x360.jpg',
    serviceTitle: '',
    serviceDescription: '',
    partnerTitle: '',
    partnerDescription: '',
